...
(function () {
  ...
  style.textContent =
    ...
    "body.leap-modal-open>*:not(.leap-modal-backdrop):not(.leap-modal){filter:blur(6px) saturate(0.7);transition:filter .25s ease;pointer-events:none;user-select:none;}" +
    ...
    ".leap-modal{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) scale(0.95);z-index:9999;width:calc(100% - 2rem);max-width:400px;background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-lg);box-shadow:var(--shadow-lg);padding:1.75rem 1.5rem;opacity:0;transition:opacity .2s ease,transform .2s ease;display:none;}" +
