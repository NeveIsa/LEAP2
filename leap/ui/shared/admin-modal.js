...
(function () {
  ...
  style.textContent =
    ...
    ".leap-modal{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) scale(0.92);z-index:9999;width:calc(100% - 2rem);max-width:400px;background:color-mix(in srgb,var(--color-surface) 30%,transparent);backdrop-filter:blur(4px) saturate(1.2);-webkit-backdrop-filter:blur(4px) saturate(1.2);border:1px solid color-mix(in srgb,var(--color-border) 60%,transparent);border-radius:var(--radius-lg);box-shadow:0 24px 48px rgba(0,0,0,0.15), 0 0 0 1px rgba(255,255,255,0.05) inset;padding:1.75rem 1.5rem;opacity:0;transition:opacity .3s ease,transform .4s cubic-bezier(0.175,0.885,0.32,1.05);display:none;}" +
